...
public class activity_reminder extends AppCompatActivity {
    ...
    private void showRemDetails(boolean extend) {
        remSubject = findViewById(R.id.cardRemSubject);
        remDetails = findViewById(R.id.cardRemDetails);
        viewRemDate = findViewById(R.id.cardRemDate);
        remDelete = findViewById(R.id.remDelete);
